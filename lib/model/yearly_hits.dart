...
class YearlyHits extends StatefulWidget {
  const YearlyHits(
      {super.key,
  ...
  final List<dynamic> yearlyHits;
  final String pageTitle;
  final String Function(String) formatTitle;

  @override
  State<YearlyHits> createState() => _YearlyHitsState();
}
...
class _YearlyHitsState extends State<YearlyHits> {
  ...
  Widget buildYearlyHitsSection(String title) {
    final itemCount = showMore ? widget.yearlyHits.length : 5;
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                final song = widget.yearlyHits[index];
